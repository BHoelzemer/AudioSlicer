...
namespace AudioSlicerLibrary
{
    [ComVisible(true)]
    [COMServerAssociation(AssociationType.Directory)]
    public class ShellExtention : SharpContextMenu
    {
        /// <summary>
        /// default needed for com
        /// </summary>
        public ShellExtention()
        {
        ...
        private void SliceAudioBook()
        {
            ...
            string destinyFolder = @"D:\bookcut";
            if (ShowInputDialog(ref destinyFolder) == DialogResult.OK)
            {
                audio.Start(mp3Files, destinyFolder, 3);
            }
